...
type AI struct {
	...
	PastPeriod         int
	SignalEvets        *models.SignalEvents
	OtimzedTradeParams *models.TradeParams
...
func (ai *AI) UpdateOptimizeParams() {
	...
	ai.OtimzedTradeParams = df.OptimizeParams()
	log.Printf("optimized_trade_params=%+v", ai.OtimzedTradeParams)
}

func (ai *AI) Buy(candle models.Candle) (childOrderAcceptanceID string, isOrderCompleted bool) {
	if ai.BackTest {
		couldBuy := ai.SignalEvets.Buy(ai.ProductCode, candle.Time, candle.Close, 0.001, false)
		return "", couldBuy
	}
	//TODO
...
func (ai *AI) Sell(candle models.Candle) (childOrderAcceptanceID string, isOrderCompleted bool) {
	if ai.BackTest {
		couldSell := ai.SignalEvets.Sell(ai.ProductCode, candle.Time, candle.Close, 0.001, false)
		return "", couldSell
	}
	//TODO
	return childOrderAcceptanceID, isOrderCompleted
